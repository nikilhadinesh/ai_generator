...
class CoreClient {
    constructor(props) {
        ...
        this.baseUrl =
            typeof props.baseUrl === "string"
                ...
                : props.baseUrl;
        this.auths = (_a = props.auths) !== null && _a !== void 0 ? _a : {};
    ...
    buildUrl(path, serviceName = _DEFAULT_SERVICE_NAME) {
        var _a;
        const baseUrl = (_a = this.baseUrl[serviceName !== null && serviceName !== void 0 ? serviceName : _DEFAULT_SERVICE_NAME]) !== null && _a !== void 0 ? _a : "";
        ...
        if (typeof cfg.body === "undefined") {
            ...
            if (runtime_1.RUNTIME.type === "node") {
                ...
                headers["content-type"] =
                    `${content_type_1.MULTIPART_FORM}; boundary=${form.getBoundary()}`;
            }
            else {
            ...
            if (typeof cfg.body !== "object") {
                throw new TypeError("x-www-form-urlencoded data must be an object at the top level");
            }
            // encode form data
            const styleMap = (_j = (_h = cfg.bodyEncoding) === null || _h === void 0 ? void 0 : _h.style) !== null && _j !== void 0 ? _j : {};
            const explodeMap = (_l = (_k = cfg.bodyEncoding) === null || _k === void 0 ? void 0 : _k.explode) !== null && _l !== void 0 ? _l : {};
            const formData = Object.entries(cfg.body).map(([name, value]) => {
                var _a, _b;
                const style = (_a = styleMap[name]) !== null && _a !== void 0 ? _a : "form";
                const explode = (_b = explodeMap[name]) !== null && _b !== void 0 ? _b : style === "form";
                return (0, query_1.encodeQueryParam)({ name, value, style, explode });
            });
    ...
    sendRequest(_a) {
        return __awaiter(this, arguments, void 0, function* ({ url, reqInit, timeout, }) {
    ...
    request(cfg) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield this.sendRequest(sendRequestData);
            if (((_c = cfg.opts) === null || _c === void 0 ? void 0 : _c.retries) || this.retries) {
                const retry = new retry_1.RetryConfig({
                    override: (_d = cfg.opts) === null || _d === void 0 ? void 0 : _d.retries,
                    base: this.retries,
                });
                let attempt = 1;
                let delay = retry.initialDelay;
                while (retry.shouldRetry({ attempt, statusCode: response.status })) {
                    yield (0, retry_1.sleep)(delay);
                    response = yield this.sendRequest(sendRequestData);
