...
import * as requests from "../../../resources/v1/lip-sync/request-types";
...
export declare class LipSyncClient extends CoreResourceClient {
     ...
     * POST /v1/lip-sync
     */
    create(request: requests.CreateRequest, opts?: RequestOptions): ApiPromise<types.V1LipSyncCreateResponse>;
}
export {};
