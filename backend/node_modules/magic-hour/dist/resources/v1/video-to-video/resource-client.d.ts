...
import * as requests from "../../../resources/v1/video-to-video/request-types";
...
export declare class VideoToVideoClient extends CoreResourceClient {
     ...
     */
    create(request: requests.CreateRequest, opts?: RequestOptions): ApiPromise<types.V1VideoToVideoCreateResponse>;
}
export {};
