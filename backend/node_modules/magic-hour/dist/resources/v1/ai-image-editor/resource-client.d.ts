...
import * as requests from "../../../resources/v1/ai-image-editor/request-types";
...
export declare class AiImageEditorClient extends CoreResourceClient {
     ...
     */
    create(request: requests.CreateRequest, opts?: RequestOptions): ApiPromise<types.V1AiImageEditorCreateResponse>;
}
export {};
