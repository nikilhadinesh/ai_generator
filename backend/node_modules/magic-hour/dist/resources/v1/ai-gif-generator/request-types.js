...
const v1_ai_gif_generator_create_body_style_1 = require("../../../types/v1-ai-gif-generator-create-body-style");
/**
...
const SchemaIn$CreateRequest = z
    ...
    style: v1_ai_gif_generator_create_body_style_1.Schemas$V1AiGifGeneratorCreateBodyStyle.in,
})
    .transform((obj) => {
...
const SchemaOut$CreateRequest = z
    ...
    style: v1_ai_gif_generator_create_body_style_1.Schemas$V1AiGifGeneratorCreateBodyStyle.out,
})
    .transform((obj) => {
    return (0, make_api_request_js_1.zodTransform)(obj, {
        name: "name",
