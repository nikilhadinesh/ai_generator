...
export declare const Schemas$V1AiVideoEditorCreateResponse: {
    in: z.ZodType<V1AiVideoEditorCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1AiVideoEditorCreateResponse, z.ZodTypeDef, V1AiVideoEditorCreateResponse>;
};
