...
exports.Schemas$V1FilesUploadUrlsCreateResponseItemsItem = void 0;
 ...
 */
const SchemaIn$V1FilesUploadUrlsCreateResponseItemsItem = z
    .object({
    expires_at: z.string(),
    file_path: z.string(),
    upload_url: z.string(),
 ...
 */
const SchemaOut$V1FilesUploadUrlsCreateResponseItemsItem = z
    .object({
    expiresAt: z.string(),
    filePath: z.string(),
    uploadUrl: z.string(),
...
exports.Schemas$V1FilesUploadUrlsCreateResponseItemsItem = {
