...
export declare const Schemas$V1AiImageUpscalerCreateResponse: {
    in: z.ZodType<V1AiImageUpscalerCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1AiImageUpscalerCreateResponse, z.ZodTypeDef, V1AiImageUpscalerCreateResponse>;
};
