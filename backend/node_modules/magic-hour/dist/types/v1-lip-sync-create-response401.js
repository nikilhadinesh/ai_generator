...
exports.Schemas$V1LipSyncCreateResponse401 = void 0;
 ...
 */
const SchemaIn$V1LipSyncCreateResponse401 = z
    .object({
 ...
 */
const SchemaOut$V1LipSyncCreateResponse401 = z
    .object({
    message: z.enum(["Unauthorized"]),
})
    .transform((obj) => {
...
exports.Schemas$V1LipSyncCreateResponse401 = {
