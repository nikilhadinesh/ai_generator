...
exports.Schemas$V1ImageProjectsGetResponseError = void 0;
 ...
 */
const SchemaIn$V1ImageProjectsGetResponseError = z
    .object({
    code: z.string(),
    message: z.string(),
})
 ...
 */
const SchemaOut$V1ImageProjectsGetResponseError = z
    .object({
    code: z.string(),
    message: z.string(),
})
...
exports.Schemas$V1ImageProjectsGetResponseError = {
