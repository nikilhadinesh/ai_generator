...
exports.Schemas$V1ImageBackgroundRemoverCreateResponse400 = void 0;
 ...
 */
const SchemaIn$V1ImageBackgroundRemoverCreateResponse400 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1ImageBackgroundRemoverCreateResponse400 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
...
exports.Schemas$V1ImageBackgroundRemoverCreateResponse400 = {
