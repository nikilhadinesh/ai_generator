...
export declare const Schemas$V1FaceSwapCreateResponse: {
    in: z.ZodType<V1FaceSwapCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1FaceSwapCreateResponse, z.ZodTypeDef, V1FaceSwapCreateResponse>;
};
