...
import { External$V1AiImageUpscalerCreateBodyAssets, V1AiImageUpscalerCreateBodyAssets } from "./v1-ai-image-upscaler-create-body-assets";
import { External$V1AiImageUpscalerCreateBodyStyle, V1AiImageUpscalerCreateBodyStyle } from "./v1-ai-image-upscaler-create-body-style";
/**
...
export declare const Schemas$V1AiImageUpscalerCreateBody: {
    in: z.ZodType<V1AiImageUpscalerCreateBody, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1AiImageUpscalerCreateBody, z.ZodTypeDef, V1AiImageUpscalerCreateBody>;
};
