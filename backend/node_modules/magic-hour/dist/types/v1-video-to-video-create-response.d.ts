...
export declare const Schemas$V1VideoToVideoCreateResponse: {
    in: z.ZodType<V1VideoToVideoCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1VideoToVideoCreateResponse, z.ZodTypeDef, V1VideoToVideoCreateResponse>;
};
