 ...
 * Success
 */
export type V1AiFaceEditorCreateResponse = {
    /**
...
/**
 * @internal
 * V1AiFaceEditorCreateResponse without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$V1AiFaceEditorCreateResponse = {
    credits_charged: number;
    frame_cost: number;
    id: string;
};
export declare const Schemas$V1AiFaceEditorCreateResponse: {
    in: z.ZodType<V1AiFaceEditorCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1AiFaceEditorCreateResponse, z.ZodTypeDef, V1AiFaceEditorCreateResponse>;
};
