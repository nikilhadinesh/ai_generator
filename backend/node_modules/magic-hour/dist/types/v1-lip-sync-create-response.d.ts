...
export declare const Schemas$V1LipSyncCreateResponse: {
    in: z.ZodType<V1LipSyncCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1LipSyncCreateResponse, z.ZodTypeDef, V1LipSyncCreateResponse>;
};
