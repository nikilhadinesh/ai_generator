...
exports.Schemas$V1FaceDetectionGetResponseFacesItem = void 0;
 ...
 */
const SchemaIn$V1FaceDetectionGetResponseFacesItem = z
    .object({
    path: z.string(),
    url: z.string(),
})
 ...
 */
const SchemaOut$V1FaceDetectionGetResponseFacesItem = z
    .object({
    path: z.string(),
    url: z.string(),
})
...
exports.Schemas$V1FaceDetectionGetResponseFacesItem = {
