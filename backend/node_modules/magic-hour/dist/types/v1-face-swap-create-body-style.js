...
exports.Schemas$V1FaceSwapCreateBodyStyle = void 0;
 ...
 */
const SchemaIn$V1FaceSwapCreateBodyStyle = z
    .object({
 ...
 */
const SchemaOut$V1FaceSwapCreateBodyStyle = z
    .object({
    version: z.enum(["default", "v1", "v2"]).optional(),
})
    .transform((obj) => {
...
exports.Schemas$V1FaceSwapCreateBodyStyle = {
