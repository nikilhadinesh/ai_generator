 ...
 * Success
 */
export type V1HeadSwapCreateResponse = {
    /**
...
/**
 * @internal
 * V1HeadSwapCreateResponse without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$V1HeadSwapCreateResponse = {
    credits_charged: number;
    frame_cost: number;
    id: string;
};
export declare const Schemas$V1HeadSwapCreateResponse: {
    in: z.ZodType<V1HeadSwapCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1HeadSwapCreateResponse, z.ZodTypeDef, V1HeadSwapCreateResponse>;
};
