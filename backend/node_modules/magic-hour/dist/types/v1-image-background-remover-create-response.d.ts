...
export declare const Schemas$V1ImageBackgroundRemoverCreateResponse: {
    in: z.ZodType<V1ImageBackgroundRemoverCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1ImageBackgroundRemoverCreateResponse, z.ZodTypeDef, V1ImageBackgroundRemoverCreateResponse>;
};
