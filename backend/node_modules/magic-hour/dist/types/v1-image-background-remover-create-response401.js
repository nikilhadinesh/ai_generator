...
exports.Schemas$V1ImageBackgroundRemoverCreateResponse401 = void 0;
 ...
 */
const SchemaIn$V1ImageBackgroundRemoverCreateResponse401 = z
    .object({
 ...
 */
const SchemaOut$V1ImageBackgroundRemoverCreateResponse401 = z
    .object({
    message: z.enum(["Unauthorized"]),
})
    .transform((obj) => {
...
exports.Schemas$V1ImageBackgroundRemoverCreateResponse401 = {
