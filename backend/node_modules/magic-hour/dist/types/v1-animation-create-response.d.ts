...
export declare const Schemas$V1AnimationCreateResponse: {
    in: z.ZodType<V1AnimationCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1AnimationCreateResponse, z.ZodTypeDef, V1AnimationCreateResponse>;
};
