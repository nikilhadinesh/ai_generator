...
exports.Schemas$V1TextToVideoCreateResponse401 = void 0;
 ...
 */
const SchemaIn$V1TextToVideoCreateResponse401 = z
    .object({
 ...
 */
const SchemaOut$V1TextToVideoCreateResponse401 = z
    .object({
    message: z.enum(["Unauthorized"]),
})
    .transform((obj) => {
...
exports.Schemas$V1TextToVideoCreateResponse401 = {
