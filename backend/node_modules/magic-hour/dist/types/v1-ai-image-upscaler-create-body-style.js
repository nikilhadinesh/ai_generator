...
exports.Schemas$V1AiImageUpscalerCreateBodyStyle = void 0;
 ...
 */
const SchemaIn$V1AiImageUpscalerCreateBodyStyle = z
    .object({
 ...
 */
const SchemaOut$V1AiImageUpscalerCreateBodyStyle = z
    .object({
    enhancement: z.enum(["Balanced", "Creative", "Resemblance"]).optional(),
    mode: z.enum(["balanced", "creative", "preserve", "pro"]).optional(),
    prompt: z.string().optional(),
...
exports.Schemas$V1AiImageUpscalerCreateBodyStyle = {
