...
exports.Schemas$V1AiTalkingPhotoCreateResponse401 = void 0;
 ...
 */
const SchemaIn$V1AiTalkingPhotoCreateResponse401 = z
    .object({
 ...
 */
const SchemaOut$V1AiTalkingPhotoCreateResponse401 = z
    .object({
    message: z.enum(["Unauthorized"]),
})
    .transform((obj) => {
...
exports.Schemas$V1AiTalkingPhotoCreateResponse401 = {
