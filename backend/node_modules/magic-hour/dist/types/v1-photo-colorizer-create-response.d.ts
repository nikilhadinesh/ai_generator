 ...
 * Success
 */
export type V1PhotoColorizerCreateResponse = {
    /**
...
/**
 * @internal
 * V1PhotoColorizerCreateResponse without any key transformation, this is what
 * we expect to come in as network data
 */
export type External$V1PhotoColorizerCreateResponse = {
    credits_charged: number;
    frame_cost: number;
    id: string;
};
export declare const Schemas$V1PhotoColorizerCreateResponse: {
    in: z.ZodType<V1PhotoColorizerCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1PhotoColorizerCreateResponse, z.ZodTypeDef, V1PhotoColorizerCreateResponse>;
};
