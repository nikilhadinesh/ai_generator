...
export declare const Schemas$V1BodySwapCreateResponse: {
    in: z.ZodType<V1BodySwapCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1BodySwapCreateResponse, z.ZodTypeDef, V1BodySwapCreateResponse>;
};
