...
export declare const Schemas$V1AiHeadshotGeneratorCreateResponse: {
    in: z.ZodType<V1AiHeadshotGeneratorCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1AiHeadshotGeneratorCreateResponse, z.ZodTypeDef, V1AiHeadshotGeneratorCreateResponse>;
};
