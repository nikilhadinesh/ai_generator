...
exports.Schemas$V1AiQrCodeGeneratorCreateResponse400 = void 0;
 ...
 */
const SchemaIn$V1AiQrCodeGeneratorCreateResponse400 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1AiQrCodeGeneratorCreateResponse400 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
...
exports.Schemas$V1AiQrCodeGeneratorCreateResponse400 = {
