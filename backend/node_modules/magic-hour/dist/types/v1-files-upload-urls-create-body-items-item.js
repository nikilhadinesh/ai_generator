...
exports.Schemas$V1FilesUploadUrlsCreateBodyItemsItem = void 0;
 ...
 */
const SchemaIn$V1FilesUploadUrlsCreateBodyItemsItem = z
    .object({
    extension: z.string(),
 ...
 */
const SchemaOut$V1FilesUploadUrlsCreateBodyItemsItem = z
    .object({
    extension: z.string(),
    type: z.enum(["audio", "image", "video"]),
})
...
exports.Schemas$V1FilesUploadUrlsCreateBodyItemsItem = {
