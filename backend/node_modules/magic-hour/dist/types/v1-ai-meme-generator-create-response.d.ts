...
export declare const Schemas$V1AiMemeGeneratorCreateResponse: {
    in: z.ZodType<V1AiMemeGeneratorCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1AiMemeGeneratorCreateResponse, z.ZodTypeDef, V1AiMemeGeneratorCreateResponse>;
};
