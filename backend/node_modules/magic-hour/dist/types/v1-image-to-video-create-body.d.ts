...
import { External$V1ImageToVideoCreateBodyAssets, V1ImageToVideoCreateBodyAssets } from "./v1-image-to-video-create-body-assets";
import { External$V1ImageToVideoCreateBodyStyle, V1ImageToVideoCreateBodyStyle } from "./v1-image-to-video-create-body-style";
/**
...
export type V1ImageToVideoCreateBody = {
     ...
     */
    model?: ("default" | "gemini-omni-1.1" | "kling-1.6" | "kling-2.5" | "kling-2.5-audio" | "kling-2.6" | "kling-3.0" | "ltx-2" | "ltx-2.3" | "ltx-2.5" | "minimax-h3" | "seedance" | "seedance-1.5" | "seedance-2.0" | "seedance-2.0-mini" | "seedance-2.5" | "sora-2" | "veo3.1" | "veo3.1-audio" | "veo3.1-lite" | "wan-2.2" | "wan-3.0") | undefined;
    /**
...
export declare const Schemas$V1ImageToVideoCreateBody: {
    in: z.ZodType<V1ImageToVideoCreateBody, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1ImageToVideoCreateBody, z.ZodTypeDef, V1ImageToVideoCreateBody>;
};
