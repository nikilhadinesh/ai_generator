...
exports.Schemas$V1TextToVideoCreateBody = void 0;
const make_api_request_js_1 = require("make-api-request-js");
const z = __importStar(require("zod"));
const v1_text_to_video_create_body_style_1 = require("./v1-text-to-video-create-body-style");
/**
 * Takes network data, validates it, and transforms keys to match typescript object V1TextToVideoCreateBody
 */
const SchemaIn$V1TextToVideoCreateBody = z
    .object({
    ...
    style: v1_text_to_video_create_body_style_1.Schemas$V1TextToVideoCreateBodyStyle.in,
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1TextToVideoCreateBody = z
    .object({
    ...
    orientation: z.enum(["landscape", "portrait", "square"]).optional(),
    resolution: z.enum(["1080p", "360p", "480p", "4k", "720p"]).optional(),
    style: v1_text_to_video_create_body_style_1.Schemas$V1TextToVideoCreateBodyStyle.out,
})
    .transform((obj) => {
    return (0, make_api_request_js_1.zodTransform)(obj, {
...
exports.Schemas$V1TextToVideoCreateBody = {
