...
exports.Schemas$V1AiVideoEditorCreateBodyStyle = void 0;
 ...
 */
const SchemaIn$V1AiVideoEditorCreateBodyStyle = z
    .object({
    prompt: z.string(),
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1AiVideoEditorCreateBodyStyle = z
    .object({
    prompt: z.string(),
})
    .transform((obj) => {
...
exports.Schemas$V1AiVideoEditorCreateBodyStyle = {
