...
exports.Schemas$V1BodySwapCreateBody = void 0;
const make_api_request_js_1 = require("make-api-request-js");
const z = __importStar(require("zod"));
const v1_body_swap_create_body_assets_1 = require("./v1-body-swap-create-body-assets");
/**
 * Takes network data, validates it, and transforms keys to match typescript object V1BodySwapCreateBody
 */
const SchemaIn$V1BodySwapCreateBody = z
    .object({
    assets: v1_body_swap_create_body_assets_1.Schemas$V1BodySwapCreateBodyAssets.in,
 ...
 */
const SchemaOut$V1BodySwapCreateBody = z
    .object({
    assets: v1_body_swap_create_body_assets_1.Schemas$V1BodySwapCreateBodyAssets.out,
    name: z.string().optional(),
    resolution: z.enum(["1k", "2k", "4k", "640px"]),
})
    .transform((obj) => {
...
exports.Schemas$V1BodySwapCreateBody = {
