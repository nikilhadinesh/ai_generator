...
exports.Schemas$V1FaceSwapPhotoCreateResponse401 = void 0;
 ...
 */
const SchemaIn$V1FaceSwapPhotoCreateResponse401 = z
    .object({
 ...
 */
const SchemaOut$V1FaceSwapPhotoCreateResponse401 = z
    .object({
    message: z.enum(["Unauthorized"]),
})
    .transform((obj) => {
...
exports.Schemas$V1FaceSwapPhotoCreateResponse401 = {
