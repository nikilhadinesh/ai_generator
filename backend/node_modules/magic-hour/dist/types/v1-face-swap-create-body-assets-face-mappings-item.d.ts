...
export declare const Schemas$V1FaceSwapCreateBodyAssetsFaceMappingsItem: {
    in: z.ZodType<V1FaceSwapCreateBodyAssetsFaceMappingsItem, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1FaceSwapCreateBodyAssetsFaceMappingsItem, z.ZodTypeDef, V1FaceSwapCreateBodyAssetsFaceMappingsItem>;
};
