...
exports.Schemas$V1AiImageUpscalerCreateResponse400 = void 0;
 ...
 */
const SchemaIn$V1AiImageUpscalerCreateResponse400 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1AiImageUpscalerCreateResponse400 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
...
exports.Schemas$V1AiImageUpscalerCreateResponse400 = {
