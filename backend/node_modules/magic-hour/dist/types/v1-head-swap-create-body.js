...
exports.Schemas$V1HeadSwapCreateBody = void 0;
const make_api_request_js_1 = require("make-api-request-js");
const z = __importStar(require("zod"));
const v1_head_swap_create_body_assets_1 = require("./v1-head-swap-create-body-assets");
/**
 * Takes network data, validates it, and transforms keys to match typescript object V1HeadSwapCreateBody
 */
const SchemaIn$V1HeadSwapCreateBody = z
    .object({
    assets: v1_head_swap_create_body_assets_1.Schemas$V1HeadSwapCreateBodyAssets.in,
 ...
 */
const SchemaOut$V1HeadSwapCreateBody = z
    .object({
    assets: v1_head_swap_create_body_assets_1.Schemas$V1HeadSwapCreateBodyAssets.out,
...
exports.Schemas$V1HeadSwapCreateBody = {
