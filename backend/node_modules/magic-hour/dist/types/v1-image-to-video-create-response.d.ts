...
export declare const Schemas$V1ImageToVideoCreateResponse: {
    in: z.ZodType<V1ImageToVideoCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1ImageToVideoCreateResponse, z.ZodTypeDef, V1ImageToVideoCreateResponse>;
};
