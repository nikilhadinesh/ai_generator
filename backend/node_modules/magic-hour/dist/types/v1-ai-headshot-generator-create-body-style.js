...
exports.Schemas$V1AiHeadshotGeneratorCreateBodyStyle = void 0;
 ...
 */
const SchemaIn$V1AiHeadshotGeneratorCreateBodyStyle = z
    .object({
 ...
 */
const SchemaOut$V1AiHeadshotGeneratorCreateBodyStyle = z
    .object({
    prompt: z.string().optional(),
})
    .transform((obj) => {
...
exports.Schemas$V1AiHeadshotGeneratorCreateBodyStyle = {
