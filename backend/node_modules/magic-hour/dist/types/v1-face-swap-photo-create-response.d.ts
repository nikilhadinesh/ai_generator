...
export declare const Schemas$V1FaceSwapPhotoCreateResponse: {
    in: z.ZodType<V1FaceSwapPhotoCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1FaceSwapPhotoCreateResponse, z.ZodTypeDef, V1FaceSwapPhotoCreateResponse>;
};
