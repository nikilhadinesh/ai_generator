...
exports.Schemas$V1AudioToVideoCreateBodyStyle = void 0;
 ...
 */
const SchemaIn$V1AudioToVideoCreateBodyStyle = z
    .object({
 ...
 */
const SchemaOut$V1AudioToVideoCreateBodyStyle = z
    .object({
    prompt: z.string().optional(),
})
    .transform((obj) => {
...
exports.Schemas$V1AudioToVideoCreateBodyStyle = {
