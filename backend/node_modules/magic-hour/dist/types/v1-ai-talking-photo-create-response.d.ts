...
export declare const Schemas$V1AiTalkingPhotoCreateResponse: {
    in: z.ZodType<V1AiTalkingPhotoCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1AiTalkingPhotoCreateResponse, z.ZodTypeDef, V1AiTalkingPhotoCreateResponse>;
};
