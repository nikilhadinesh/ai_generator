...
exports.Schemas$V1AudioProjectsGetResponseError = void 0;
 ...
 */
const SchemaIn$V1AudioProjectsGetResponseError = z
    .object({
    code: z.string(),
    message: z.string(),
})
 ...
 */
const SchemaOut$V1AudioProjectsGetResponseError = z
    .object({
    code: z.string(),
    message: z.string(),
})
...
exports.Schemas$V1AudioProjectsGetResponseError = {
