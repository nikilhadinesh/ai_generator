...
import { External$V1AutoSubtitleGeneratorCreateBodyAssets, V1AutoSubtitleGeneratorCreateBodyAssets } from "./v1-auto-subtitle-generator-create-body-assets";
import { External$V1AutoSubtitleGeneratorCreateBodyStyle, V1AutoSubtitleGeneratorCreateBodyStyle } from "./v1-auto-subtitle-generator-create-body-style";
/**
...
export declare const Schemas$V1AutoSubtitleGeneratorCreateBody: {
    in: z.ZodType<V1AutoSubtitleGeneratorCreateBody, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1AutoSubtitleGeneratorCreateBody, z.ZodTypeDef, V1AutoSubtitleGeneratorCreateBody>;
};
