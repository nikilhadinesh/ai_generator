...
exports.Schemas$V1AiImageEditorCreateBodyStyle = void 0;
 ...
 */
const SchemaIn$V1AiImageEditorCreateBodyStyle = z
    .object({
 ...
 */
const SchemaOut$V1AiImageEditorCreateBodyStyle = z
    .object({
    model: z.enum(["Nano Banana", "Seedream", "default"]).optional(),
    prompt: z.string(),
})
...
exports.Schemas$V1AiImageEditorCreateBodyStyle = {
