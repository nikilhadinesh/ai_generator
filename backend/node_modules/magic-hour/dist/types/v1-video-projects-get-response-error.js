...
exports.Schemas$V1VideoProjectsGetResponseError = void 0;
 ...
 */
const SchemaIn$V1VideoProjectsGetResponseError = z
    .object({
    code: z.string(),
    message: z.string(),
})
 ...
 */
const SchemaOut$V1VideoProjectsGetResponseError = z
    .object({
    code: z.string(),
    message: z.string(),
})
...
exports.Schemas$V1VideoProjectsGetResponseError = {
