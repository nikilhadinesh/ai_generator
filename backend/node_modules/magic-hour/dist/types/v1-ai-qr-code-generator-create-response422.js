...
exports.Schemas$V1AiQrCodeGeneratorCreateResponse422 = void 0;
 ...
 */
const SchemaIn$V1AiQrCodeGeneratorCreateResponse422 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1AiQrCodeGeneratorCreateResponse422 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
...
exports.Schemas$V1AiQrCodeGeneratorCreateResponse422 = {
