...
exports.Schemas$V1AiVoiceClonerCreateBodyStyle = void 0;
 ...
 */
const SchemaIn$V1AiVoiceClonerCreateBodyStyle = z
    .object({
    prompt: z.string(),
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1AiVoiceClonerCreateBodyStyle = z
    .object({
    prompt: z.string(),
})
    .transform((obj) => {
...
exports.Schemas$V1AiVoiceClonerCreateBodyStyle = {
