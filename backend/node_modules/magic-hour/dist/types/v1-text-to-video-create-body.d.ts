...
import { External$V1TextToVideoCreateBodyStyle, V1TextToVideoCreateBodyStyle } from "./v1-text-to-video-create-body-style";
/**
...
export declare const Schemas$V1TextToVideoCreateBody: {
    in: z.ZodType<V1TextToVideoCreateBody, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1TextToVideoCreateBody, z.ZodTypeDef, V1TextToVideoCreateBody>;
};
