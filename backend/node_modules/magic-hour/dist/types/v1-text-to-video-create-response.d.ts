...
export declare const Schemas$V1TextToVideoCreateResponse: {
    in: z.ZodType<V1TextToVideoCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1TextToVideoCreateResponse, z.ZodTypeDef, V1TextToVideoCreateResponse>;
};
