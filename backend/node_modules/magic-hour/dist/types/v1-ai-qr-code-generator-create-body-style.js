...
exports.Schemas$V1AiQrCodeGeneratorCreateBodyStyle = void 0;
 ...
 */
const SchemaIn$V1AiQrCodeGeneratorCreateBodyStyle = z
    .object({
    art_style: z.string(),
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1AiQrCodeGeneratorCreateBodyStyle = z
    .object({
    artStyle: z.string(),
})
    .transform((obj) => {
...
exports.Schemas$V1AiQrCodeGeneratorCreateBodyStyle = {
