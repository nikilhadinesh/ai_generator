...
exports.Schemas$V1LipSyncCreateResponse422 = void 0;
 ...
 */
const SchemaIn$V1LipSyncCreateResponse422 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1LipSyncCreateResponse422 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
...
exports.Schemas$V1LipSyncCreateResponse422 = {
