...
export declare const Schemas$V1AiImageEditorCreateResponse: {
    in: z.ZodType<V1AiImageEditorCreateResponse, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1AiImageEditorCreateResponse, z.ZodTypeDef, V1AiImageEditorCreateResponse>;
};
