...
exports.Schemas$V1AiGifGeneratorCreateBodyStyle = void 0;
 ...
 */
const SchemaIn$V1AiGifGeneratorCreateBodyStyle = z
    .object({
    prompt: z.string(),
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1AiGifGeneratorCreateBodyStyle = z
    .object({
    prompt: z.string(),
})
    .transform((obj) => {
...
exports.Schemas$V1AiGifGeneratorCreateBodyStyle = {
