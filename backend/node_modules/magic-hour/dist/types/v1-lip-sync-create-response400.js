...
exports.Schemas$V1LipSyncCreateResponse400 = void 0;
 ...
 */
const SchemaIn$V1LipSyncCreateResponse400 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
 ...
 */
const SchemaOut$V1LipSyncCreateResponse400 = z
    .object({
    message: z.string(),
})
    .transform((obj) => {
...
exports.Schemas$V1LipSyncCreateResponse400 = {
