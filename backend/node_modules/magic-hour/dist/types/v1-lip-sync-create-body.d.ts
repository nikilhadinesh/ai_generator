...
import { External$V1LipSyncCreateBodyAssets, V1LipSyncCreateBodyAssets } from "./v1-lip-sync-create-body-assets";
import { External$V1LipSyncCreateBodyStyle, V1LipSyncCreateBodyStyle } from "./v1-lip-sync-create-body-style";
/**
 * V1LipSyncCreateBody
 */
...
export declare const Schemas$V1LipSyncCreateBody: {
    in: z.ZodType<V1LipSyncCreateBody, z.ZodTypeDef, unknown>;
    out: z.ZodType<External$V1LipSyncCreateBody, z.ZodTypeDef, V1LipSyncCreateBody>;
};
