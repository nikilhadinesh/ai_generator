...
exports.Schemas$V1AnimationCreateResponse401 = void 0;
 ...
 */
const SchemaIn$V1AnimationCreateResponse401 = z
    .object({
 ...
 */
const SchemaOut$V1AnimationCreateResponse401 = z
    .object({
    message: z.enum(["Unauthorized"]),
})
    .transform((obj) => {
...
exports.Schemas$V1AnimationCreateResponse401 = {
